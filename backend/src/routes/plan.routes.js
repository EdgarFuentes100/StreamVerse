...
const { listaContendio, verificarPermisoVideo, listadoPlanes, crearPlan, actualizarPlan, eliminarPlan, planActual,  } = require('../controllers/plan.controller');
...
router.get('/planActual/:idCuenta', planActual);
