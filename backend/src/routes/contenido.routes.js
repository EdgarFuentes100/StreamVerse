...
const { listaContenido, listaPopular, listaNuevo, listaGrupo, contenidoInfo, contenidoCategoria, crearContenido, actualizarContenido, eliminarContenido } = require('../controllers/contenido.controller');
